...
import { ShoppingBag, MessageCircle, Mail, CheckCircle, XCircle, AlertCircle, RefreshCw, CreditCard, DollarSign } from 'lucide-react';
...
export const invoiceDetailsData = {
  ...
  // Caso 4: Nota de crédito con suscripción
  'B12345656': {
    id: '4',
    invoiceNumber: 'B12345656',
    documentType: 'Cambio de plan con ajuste de crédito',
    status: 'paid',
    total: -10250.00,
    ...
    // Nota de crédito
    creditNote: {
      reason: 'Cambio de plan mensual a anual',
      description: 'Crédito por la diferencia entre el plan mensual ya pagado y el descuento del plan anual',
      originalCharge: 12000.00,
      creditAmount: 10250.00,
      netAmount: 1750.00
    },
